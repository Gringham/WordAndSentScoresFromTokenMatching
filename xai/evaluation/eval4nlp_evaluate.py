...
from xai.evaluation.prepare_submission import extract_attributions
    ...
    for key in attributions_per_key.keys():
        ...
        if src_attributions_per_key and 'TAGS_SRC' in gt:
            try:
                ...
                # for the test data the split is called a bit differently, as I hadn't had it transformed to list before
                auc_src, ap_src, rec_tok_src = evaluate_word_level(
